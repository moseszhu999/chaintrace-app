...
import { updateV2OrganizationMemberRole } from "@/lib/repositories/v2-organization-repository";
...
export async function PATCH(request: Request, context: RouteContext) {
  try {
    ...
    const member = await updateV2OrganizationMemberRole({ membershipId: id, role });
