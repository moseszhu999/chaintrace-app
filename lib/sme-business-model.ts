...
export const sampleBusinessModules: BusinessModule[] = [
  ...
  },
  {
    ...
    descriptionZh: "管理 stablecoin 收款、RWA 托管钱包、链上 hash 锚定和签名权限。",
    descriptionEn: "Manage stablecoin collection, RWA escrow wallets, on-chain hash anchors, and signing permissions.",
    entryHref: "/business-wallet",
    statusZh: "USDC 余额与放款草稿",
    statusEn: "USDC balance and disbursement draft",
  },
  {
    id: "module_cashflow",
    titleZh: "融资 / RWA",
    titleEn: "Financing / RWA",
    descriptionZh: "在资金管理和钱包基础上判断应收账款融资和 RWA 资格。",
    descriptionEn: "Judge receivable financing and RWA eligibility on top of funds and wallet management.",
...
export const sampleBusinessStages: BusinessStage[] = [
  ...
  },
  {
    id: "stage_finance",
    order: 6,
    titleZh: "资金 / 钱包 / 收款 / 融资 / 对外证明",
    titleEn: "Funds / wallet / collection / financing / external proof",
    ownerZh: "老板 / 财务",
    ownerEn: "Owner / finance",
    status: "waiting",
    outcomeZh: "管理现金、应收、应付、stablecoin 钱包，并向买家、资金方或合作方提供选择性证明。",
    outcomeEn: "Manage cash, receivables, payables, stablecoin wallets, and share selective proof with buyers, financiers, or partners.",
    primaryDocsZh: ["资金流水", "钱包交易", "公开验证链接", "收款状态", "融资材料包"],
    primaryDocsEn: ["Funds ledger", "Wallet transactions", "Public verification link", "Collection status", "Financing pack"],
    nextActionZh: "先看资金缺口和钱包权限，补齐验收后再生成融资状态说明。",
    nextActionEn: "Review funding gap and wallet permissions first, then generate financing status note after acceptance is completed.",
  },
];
