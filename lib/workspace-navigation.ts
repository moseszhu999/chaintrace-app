export type WorkspaceNavKey = "flows" | "architecture" | "logistics" | "readiness" | "signing" | "loan" | "contracts" | "dashboard" | "business" | "funds" | "wallet" | "proofPacks" | "evidence" | "tasks" | "assistant" | "approvals";
