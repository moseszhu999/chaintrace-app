...
export const blmSections: ArchitectureSection[] = [
  ...
  },
  {
    ...
    summaryZh: "早期卖点不是 RWA，而是 AI Agent 替代人工整理证据，智能合约减少流程摩擦，并自动生成融资材料包。",
    summaryEn: "The early business is not RWA issuance; it is AI agents replacing manual evidence work, smart contracts reducing process friction, and automated financing-pack generation.",
    pointsZh: ["出口商减少整理资料和反复解释的人工成本。", "资金方减少尽调、预审 memo 和放款前人工复核成本。", "智能合约减少多方确认、状态同步、授信占用、放款条件检查中的摩擦。", "平台可收 SaaS 费、Agent 处理费、材料包费、预审服务费和融资成功服务费。"],
    pointsEn: ["Exporters reduce manual document preparation and explanation cost.", "Financiers reduce due-diligence, pre-review memo, and pre-disbursement re-check cost.", "Smart contracts reduce friction in multi-party confirmation, state synchronization, credit-line reservation, and disbursement-condition checks.", "The platform can charge SaaS, agent-processing, pack generation, pre-review, and success fees."],
  },
];
