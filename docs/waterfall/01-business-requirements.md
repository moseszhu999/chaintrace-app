...
| Funding provider / bank / factoring institution | Review financing cases and decide lending actions. | Know authenticity, evidence completeness, risk threshold result, and whether lending is safe. |
